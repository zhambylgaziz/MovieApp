...
class MovieByGenresAdapter(private val movies: ArrayList<Movie> = ArrayList()) : RecyclerView.Adapter<MovieByGenresAdapter.ViewHolder>(){

    private lateinit var movieClickListener: MovieClickListener

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieByGenresAdapter.ViewHolder
